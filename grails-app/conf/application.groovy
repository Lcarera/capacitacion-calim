...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.zifras.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.zifras.UserRole'
grails.plugin.springsecurity.authority.className = 'com.zifras.Role'
...
grails {
	mail {
		...
		port = 587
		username = "notificaciones@calim.com.ar"
		password = "fdb3cd354ed1a99eae431dc0d2d929be-f135b0f1-1d6d86c3"
