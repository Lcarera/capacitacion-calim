			...
			<div class="row align-items-end">
				<div class="col-lg-8">
					<div class="page-header-title">
						<div class="d-inline">
		                    <h4><g:message code="default.edit.label" default="Editar {0}" args="['Condición IVA']"/></h4>
						</div>
					</div>
				</div>
				<div class="col-lg-4">
				...
				<div class="col-sm-12">
					...
					<div class="card">
						<div class="card-block">
							<h4 class="sub-title">Condición IVA</h4>
...
$(document).ready(function () {
	...
	document.querySelector('.alert-success-cancel').onclick = function(){
		...
		function(isConfirm) {
			if (isConfirm) {
				window.location.href = $('#urlDelete').text() + '/' + ${condicionIvaInstance?.condicionIvaId};
			}
		});
	};
});
