...
<div style="display: none;">
	<div id="urlGetRetencionesPercepciones">
		<g:createLink controller="RetencionPercepcionIIBB" action="ajaxGetRetencionesPercepciones" />
	</div>
	<div id="urlShow">
		<g:createLink controller="RetencionPercepcionIIBB" action="show" />
	</div>
	<div id="urlEdit">
		<g:createLink controller="RetencionPercepcionIIBB" action="edit" />
	</div>	
			...
			<div class="row align-items-end">
				<div class="col-sm-7">
					<div class="page-header-title">
						<div class="d-inline">
		                    <h4><g:message code="zifras.RetencionPercepcion.list.label" default="Percepciones/Retenciones IIBB"/></h4>
						</div>
					</div>
				</div>
