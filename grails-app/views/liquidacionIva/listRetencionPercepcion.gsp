...
<div style="display: none;">
	...
	<div id="urlModificarRetencionPercepcion">
		<g:createLink controller="liquidacionIva" action="ajaxModificarRetencionPercepcion" />
	</div>
</div>
<div class="main-body">
			...
			<div class="row align-items-end">
				<div class="col-lg-4">
					<div class="page-header-title">
						<div class="d-inline">
		                    <h4><g:message code="zifras.liquidacion.RetencionesPercepciones.list.label" default="Retenciones/Percepciones"/></h4>
						</div>
					</div>
				</div>
				<div class="col-lg-4">
...
<div class="modal fade" id="modalRetencionPercepcion" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button id="botonRetencionPercepcion" type="button" class="btn btn-primary waves-effect waves-light" onclick="modificarRetencionPercepcion();">Modificar</button>
...
function modificarRetencionPercepcion(){
	...
	$.ajax($('#urlModificarRetencionPercepcion').text(), {
		...
		$("#modalRetencionPercepcion").modal('hide');
	});
}
</script>
</body>
