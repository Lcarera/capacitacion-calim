...
<div style="display: none;">
	<div id="urlDelete">
		<g:createLink controller="medioPago" action="delete" />
	</div>	
</div>
<div class="main-body">
			...
			<div class="row align-items-end">
				<div class="col-lg-8">
					<div class="page-header-title">
						<div class="d-inline">
		                    <h4><g:message code="default.add.label" default="Editar {0}" args="['Medio de Pago']"/></h4>
						</div>
					</div>
				</div>
				<div class="col-lg-4">
				...
				<div class="col-sm-12">
					...
					<div class="card">
						<div class="card-block">
							<h4 class="sub-title">Editar Medio de Pago</h4>
							<g:uploadForm action="update">
								...
								<div class="row">
									...
									<div class="col-sm-10">
										...
										<g:link class="btn btn-inverse m-b-0" controller="medioPago" action="list"><g:message code="default.button.back.label" default="Volver" /></g:link>
									</div>
								</div>
							</g:uploadForm>
						</div>
...
<script type="text/javascript">
	...
	document.querySelector('.alert-success-cancel').onclick = function(){
		swal({
			...
			text: "<g:message code='zifras.documento.FacturaCuenta.delete.message' default='El medio de pago se eliminará'/>",
			type: "warning",
		...
		function(isConfirm) {
			if (isConfirm) {
				window.location.href = $('#urlDelete').text() + '?id=' + ${medioPagoInstance?.medioPagoId};
			}
		});
	};
});
