					...
					<div class="row align-items-end">
						<div class="col-lg-8">
							<div class="page-header-title">
								<div class="d-inline">
									<h4>
										<g:message code="default.edit.label" default="Editar {0}" args="['Servicio']"/>
									</h4>
								</div>
							</div>
						</div>
			...
			$(document).ready(function () {
				...
				document.querySelector('.alert-success-cancel').onclick = function(){
					swal({
						...
						text: "<g:message code='zifras.servicio.Servicio.delete.message' default='El servicio se eliminará'/>",
						type: "warning",
					...
					function(isConfirm) {
						if (isConfirm) {
							window.location.href = "${createLink(action:'delete')}" + '/' + ${servicioInstance?.servicioId};
						}
					});
				};
			});
