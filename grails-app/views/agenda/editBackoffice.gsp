...
<div style="display: none;">
	<div id="urlDelete">
		<g:createLink controller="agenda" action="deleteBackoffice" />
	</div>	
</div>
<div class="main-body">
				...
				<div class="col-sm-12">
					...
					<div class="card">
						<div class="card-block">
							...
							<g:uploadForm controller="agenda" action="updateBackoffice">
								...
								<div class="row">
									...
									<div class="col-sm-10">
										...
										<g:link class="btn btn-inverse m-b-0" action="clientesProveedoresBack" id="${cuentaId}"><g:message code="default.button.back.label" default="Volver" /></g:link>
									</div>
								</div>
							</g:uploadForm>
						</div>
...
$(document).ready(function () {
	...
	document.querySelector('.alert-success-cancel').onclick = function(){
		swal({
			...
			text: "<g:message code='zifras.documento.FacturaCuenta.delete.message' default='El cliente/proveedor se eliminará'/>",
			type: "warning",
		...
		function(isConfirm) {
			if (isConfirm) {
				window.location.href = $('#urlDelete').text() + '?id=' + ${clienteProveedorInstance?.clienteProveedorId} + '&cuentaId=' + ${cuentaId}
			}
		});
	};
});
