...
<div style="display: none;">
	...
	<div id="urlCrearCliProv">
		<g:createLink controller="agenda" action="create" />
	</div>
</div>
...
<div class="main-body">
	<div class="page-wrapper">	
			...
			<div class="row align-items-end">
				<div class="col-lg-8">
					<div class="page-header-title">
						<div class="d-inline">
		                    <h4><g:message code="zifras.documento.DeclaracionJurada.list.label" default="Clientes"/></h4>
						</div>
					</div>
				</div>
			</div>
		...
		<g:link action="create" class="btn btn-success" params="[path:'agenda']"><g:message code="default.add.label" default="Agregar {0}" args="['Cliente']"/></g:link>
		</div>
		</div>
	</div>
</div>
    ...
    tablaClientes = $('#listClientes').DataTable({
		...
		fnRowCallback: function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
				...
				$(nRow).on('click', function() {
					window.location.href = $('#urlEdit').text() + '?id=' + aData['id'] + '&tipo=clientes';
				});
			}
