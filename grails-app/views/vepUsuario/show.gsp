						...
						<div class="card-block user-detail-card">
							<div class="row">
								<div class="col-sm-12 user-detail">
									...
									<div class="row">
										<div class="col-sm-5">
											<h6 class="f-w-400 m-b-30"><g:message code="zifras.vep.Vep.numero.label" default="Numero" /></h6>
										</div>
										<div class="col-sm-7">
							...
							<div class="row">
								<div class="col-sm-12 user-detail">
									...
									<div class="row">
										<div class="col-sm-5">
											<h6 class="f-w-400 m-b-30"><g:message code="zifras.vep.Vep.cuenta.label" default="Cuenta" /></h6>
										</div>
										<div class="col-sm-7">
							...
							<div class="row">
								<div class="col-sm-12 user-detail">
									...
									<div class="row">
										<div class="col-sm-5">
											<h6 class="f-w-400 m-b-30"><g:message code="zifras.vep.Vep.estadoId.label" default="Estado" /></h6>
										</div>
										<div class="col-sm-7">
							...
							<div class="row">
								<div class="col-sm-12 user-detail">
									...
									<div class="row">
										<div class="col-sm-5">
											<h6 class="f-w-400 m-b-30"><g:message code="zifras.vep.Vep.importe.label" default="Importe" /></h6>
										</div>
										<div class="col-sm-7">
							...
							<div class="row">
								<div class="col-sm-12 user-detail">
									...
									<div class="row">
										<div class="col-sm-5">
											<h6 class="f-w-400 m-b-30"><g:message code="zifras.vep.Vep.descripcion.label" default="Descripcion" /></h6>
										</div>
										<div class="col-sm-7">
							...
							<div class="row">
								<div class="col-sm-12 user-detail">
									...
									<div class="row">
										<div class="col-sm-5">
											<h6 class="f-w-400 m-b-30"><g:message code="zifras.vep.Vep.fechaPago.label" default="Fecha de Pago" /></h6>
										</div>
										<div class="col-sm-7">
...
$(document).ready(function () {
	...
	document.querySelector('.alert-success-cancel').onclick = function(){
		swal({
			...
			text: "<g:message code='zifras.cuenta.Actividad.delete.message' default='La condición se eliminará'/>",
			type: "warning",
