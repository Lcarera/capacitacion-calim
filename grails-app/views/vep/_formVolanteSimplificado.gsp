...
<div style="display: none;">
	<div id="urlGetCuentas">
		<g:createLink controller="cuenta" action="ajaxGetCuentasMonoSimplificadoList" />
	</div>
...
<div class="form-group row">
	...
	<div class="col-sm-10">
		<input id="fecha" name="fechaEmision" class="form-control" type="text" data-format="d/m/Y" placeholder="Seleccione un día" value="${vepInstance?.fechaEmision?.toString('dd/MM/yyyy')}"/>
	</div>
</div>
