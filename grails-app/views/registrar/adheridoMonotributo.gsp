            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="signup-card auth-body mr-auto ml-auto">
                        <g:form action="pasosRegistro" class="md-float-material" name="formAdheridoMono">
                            <g:hiddenField name="pasoActual" value="adheridoMonotributo"/>
                            ...
                            <div class="col-md-12">
                                <div class="progress">
                                    <div class="progress-bar progress-bar-primary" role="progressbar" style="width: 48%" aria-valuenow="48" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="auth-box">
                                <h5 class="b-b-default text-left txt-primary m-b-20 ttl-login"/>¿Necesitás inscribirte en Monotributo?</h5>
