                ...
                <div class="col-sm-12">
                    ...
                    <div class="signup-card auth-body mr-auto ml-auto">
                        <g:form action="pasosRegistro" class="md-float-material" name="formIngresoProv">
                            <g:hiddenField name="pasoActual" value="ingresoProvincia"/>
                            ...
                            <div class="col-md-12">
                                <div class="progress">
                                    <div class="progress-bar progress-bar-primary" role="progressbar" style="width: 90%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="auth-box">
                                <g:if test="${flash.error}">
                                    <div class="alert alert-danger background-danger">
                                        ...
                                        <strong>${flash.error} <br/> Sin embargo, puedes continuar con la creación de la cuenta.</strong>
                                    </div>
                                </g:if>
                                <h5 class="b-b-default text-left txt-primary m-b-20 ttl-login"/>¿En qué provincia trabajás?</h5>
                                    <div class="input-group input-group-register">
                                        <select id="cbProvincia" name="provinciaId" class="form-control input-register"></select>
                                    </div>
                                    <hr/>
                                    <div class="row">
                                        <div class="col-6">
