            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card auth-body mr-auto ml-auto" style="color:#666666;">
                        <g:form action="pasosRegistro" class="md-float-material" name="formShowDatosRefactor">
                            ...
                            <g:hiddenField name="pasoActual" value="showDatosRefactor"/>
