            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="signup-card auth-body mr-auto ml-auto">
                        <g:form action="pasosRegistro" class="md-float-material" name="formIngresoDomicilio">
                            <g:hiddenField name="pasoActual" value="ingresoDomicilio"/>
                            ...
                            <div class="auth-box">                             
                                ...
                                <h5 class="b-b-default text-left txt-primary m-b-20 ttl-login"/>¿Cual es el domicilio que figura en tu documento?</h5>
                                    <div class="input-group input-group-register">
                                        <select id="cbProvincia" name="provinciaId" class="form-control input-register" value="${provinciaId}"></select>
                                    </div>
                                    <div class="input-group input-group-register">
                                        <input onkeyup="validarCuit($(this));" type="text" name="localidad" id="localidad" value="${domicilio}" class="form-control input-register" placeholder="Localidad">
                                        <span class="md-line"></span>
                                    </div>
                                    <div class="input-group input-group-register">
                                        <input onkeyup="validarCuit($(this));" type="text" name="direccion" id="direccion" value="${domicilio}" class="form-control input-register" placeholder="Dirección">
                                        <span class="md-line"></span>
                                    </div>
                                    <div class="input-group input-group-register">
                                        <input onkeyup="validarCuit($(this));" type="text" name="pisoDpto" id="pisoDpto" value="${domicilio}" class="form-control input-register" placeholder="Piso y Departamento">
                                        <span class="md-line"></span>
                                    </div>
                                    <div class="input-group input-group-register">
                                        <input onkeyup="validarCuit($(this));" type="text" name="codigoPostal" id="codigoPostal" value="${domicilio}" class="form-control input-register" maxlength="4" placeholder="Código Postal">
                                        <span class="md-line"></span>
                                    </div>
                                    <hr/>
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <button id="submitBtn" type="button" style="width:100%" class="formBtn btn btn-primary block waves-effect">Siguiente</button>
                                       </div>
                                    </div>
                            </div>
                        </g:form>
  ...
  <i class="fa fa-whatsapp my-float"></i>
    ...
    $(document).ready(function () {
        ...
        volverButton.onclick = function() {
            ...
            $("#formIngresoDomicilio").submit();
        };

        submitButton.onclick = function() {
            if($('#localidad').val()==""){
                alert("Debés ingresar tu localidad");
                event.preventDefault();
            }else if($('#direccion').val()==""){
                alert("Debés ingresar tu dirección");
                event.preventDefault();
            }else {
                $("#formIngresoDomicilio").submit();
                $(".formBtn").attr("disabled", true);
        ...
        setInputFilter(document.getElementById("codigoPostal"), function(value) {
