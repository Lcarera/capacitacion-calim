...
<div style="display: none;">
	<div id="urlDelete">
		<g:createLink controller="provincia" action="delete" />
	</div>	
</div>
<div class="main-body">
			...
			<div class="row align-items-end">
				<div class="col-lg-8">
					<div class="page-header-title">
						<div class="d-inline">
		                    <h4><g:message code="default.show.label" default="Mostrar {0}" args="['Provincia']"/></h4>
						</div>
					</div>
				</div>
				<div class="col-lg-4">
						...
						<div class="card-block user-detail-card">
							<div class="row">
								<div class="col-sm-12 user-detail">
									...
									<div class="row">
										<div class="col-sm-5">
											<h6 class="f-w-400 m-b-30"><g:message code="zifras.Provincia.nombre.label" default="Nombre" /></h6>
										</div>
										<div class="col-sm-7">
											<h6 class="m-b-30">${provinciaInstance?.nombre}</h6>
										</div>
									</div>
									</g:if>
								</div>
							...
							<div class="row">
								<div class="col-sm-12">
									...
									<g:link class="btn btn-primary m-b-0" action="edit" id="${provinciaInstance?.id}"><g:message code="default.button.edit.label" default="Editar" /></g:link>
...
$(document).ready(function () {
	...
	document.querySelector('.alert-success-cancel').onclick = function(){
		swal({
			...
			text: "<g:message code='zifras.Provincia.delete.message' default='La provincia se eliminará'/>",
			type: "warning",
		...
		function(isConfirm) {
			if (isConfirm) {
				window.location.href = $('#urlDelete').text() + '/' + ${provinciaInstance?.id};
			}
		});
	};
});
