...
<div style="display: none;">
	...
	<div id="urlEnviarNotificaciones">
		<g:createLink controller="liquidacionIibb" action="ajaxEnviarNotificaciones" />
	</div>
</div>
<div class="main-body">
			...
			<div class="row align-items-end">
				<div class="col-lg-4">
					<div class="page-header-title">
						<div class="d-inline">
		                    <h4><g:message code="zifras.liquidacion.LiquidacionIIBB.list.notificacion.label" default="Liq. Notificación de IIBB"/></h4>
						</div>
					</div>
				</div>
				<div class="col-lg-4">
