...
<div style="display: none;">
	...
	<div id="urlModificarNota">
		<g:createLink controller="liquidacionIibb" action="ajaxModificarNota" />
	</div>
</div>
<div class="main-body">
			...
			<div class="row align-items-end">
				<div class="col-lg-8">
					<div class="page-header-title">
						<div class="d-inline">
		                    <h4><g:message code="zifras.liquidacion.NotaIIBB.list.label" default="Nota IIBB"/></h4>
						</div>
					</div>
				</div>
				<div class="col-lg-2">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button id="botonRetencionSircreb" type="button" class="btn btn-primary waves-effect waves-light" onclick="agregarNota();">Modificar</button>
