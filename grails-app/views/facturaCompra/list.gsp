		...
		<div class="page-header card">
			<div class="row align-items-end">
				...
				<div class="col-sm-5" style="text-align:right;">
					...
					<button id="buttonCrear" type="button" class="btn btn-success" onclick="agregarFacturaCompra()" ><g:message code="default.add.label" default="Agregar {0}" args="['Factura']"/></button>
				</div>
			</div>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Importar facturas de compra</h4>
			...
			<div class="modal-body" style="padding:0px;">
				...
				<div class="form-group row col-sm-12" style="margin-top: 20px;">
					...
					<input id="compraString" name="compraString" type="hidden"value="true"/>
				</div>
					<div class="card-block">
...
var tabla;
	...
	jQuery(document).ready(function() {
		...
		tabla = $('#listFacturasCompra').DataTable({
			...
			oLanguage: {
				...
				sZeroRecords: "${message(code: 'zifras.FacturaCompra.list.agregar', default: 'No hay FacturasCompra')}</a>",
       		...
       		buttons: [
   	            ...
   	            $.extend( true, {}, buttonCommon, {
					...
					exportOptions: {
   	            	...
   	            	title: function () {
							var nombre = "Subdiario Compras " + $("#mes").val() + "-" + $("#ano").val();
							return nombre;
						}
				} ),
   	            {
	...
	function agregarFacturaCompra(){
		var urlBase = "${raw(createLink(action:'create', params:[cuentaId:'var']))}"
		urlBase = urlBase.replace('var', $("#cbCuenta").val());
