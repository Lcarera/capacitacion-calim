			...
			<div class="row align-items-end">
				<div class="col-lg-4">
					<div class="page-header-title">
						<div class="d-inline">
							<h4>Declaraciones Juradas y VEPs</h4>
						</div>
					</div>
				</div>
				<div class="col-lg-4">
				...
				<div class="modal-content">
					...
					<div class="modal-body" style="padding:0px;">
						...
						<div class="col-md-12">
							<div class="checkbox-fade fade-in-primary">
								<label class="check-task">
									<input id="ddjjIva" name="ddjjIva" type="checkbox">
									<span class="cr">
						...
						<div class="col-md-12">
							<div class="checkbox-fade fade-in-primary">
								<label class="check-task">
									<input id="ddjjIibb" name="ddjjIibb" type="checkbox">
									<span class="cr">
										<i class="cr-icon icofont icofont-ui-check txt-primary"></i>
									</span>
									<span>DDJJ IIBB</span>
						...
						<div class="col-md-12">
							<div class="checkbox-fade fade-in-primary">
								<label class="check-task">
									<input id="vepIibb" name="vepIibb" type="checkbox">
									<span class="cr">
										<i class="cr-icon icofont icofont-ui-check txt-primary"></i>
									</span>
									<span>VEP IIBB</span>
						...
						<div class="col-md-12">
							<div class="checkbox-fade fade-in-primary">
								<label class="check-task">
									<input id="vepIva" name="vepIva" type="checkbox">
									<span class="cr">
										<i class="cr-icon icofont icofont-ui-check txt-primary"></i>
									</span>
									<span>VEP IVA</span>
...
var todoSeleccionado = false;
	...
	jQuery(document).ready(function() {
		...
		tabla = $('#listCuentas').DataTable({
			...
			oLanguage: {
				...
				sZeroRecords: "Ninguna cuenta completó la etapa 2.",
	...
	function accion(){
		...
		$('#loaderCuenta').show()
		$.ajax("${createLink(action:'ejecutarEtapa3')}", {
			dataType: "json",
			method: "POST",
			data: {
				cuentas: cuentasIds,
				mes: $("#mes").val(),
				ano: $("#ano").val(),
				ddjjIva: $("#ddjjIva").prop('checked'),
				ddjjIibb: $("#ddjjIibb").prop('checked'),
				vepIibb: $("#vepIibb").prop('checked'),
				vepIva: $("#vepIva").prop('checked'),
