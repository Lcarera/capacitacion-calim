...
<div style="display: none;">
	<div id="urlDelete">
		<g:createLink controller="rangoImpuestoGanancia" action="delete" />
	</div>	
</div>
<div class="main-body">
			...
			<div class="row align-items-end">
				<div class="col-lg-8">
					<div class="page-header-title">
						<div class="d-inline">
		                    <h4><g:message code="default.edit.label" default="Editar {0}" args="['Rango de Impuesto de Ganancia']"/></h4>
						</div>
					</div>
				</div>
				<div class="col-lg-4">
...
$(document).ready(function () {
	...
	document.querySelector('.alert-success-cancel').onclick = function(){
		swal({
			...
			text: "<g:message code='zifras.liquidacion.RangoImpuestoGanancia.delete.message' default='El rango se eliminará'/>",
			type: "warning",
		...
		function(isConfirm) {
			if (isConfirm) {
				window.location.href = $('#urlDelete').text() + '/' + ${rangoImpuestoGananciaInstance?.rangoImpuestoGananciaId};
			}
		});
	};
});
