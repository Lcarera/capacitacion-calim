...
<html>
    ...
    <body>
        ...
        <div id="show-vuelo" class="content scaffold-show" role="main">
            ...
            <f:display bean="vuelo" />
            <g:form resource="${this.vuelo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.vuelo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
