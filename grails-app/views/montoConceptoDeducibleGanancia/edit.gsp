...
<div style="display: none;">
	<div id="urlDelete">
		<g:createLink controller="montoConceptoDeducibleGanancia" action="delete" />
	</div>	
</div>
<div class="main-body">
			...
			<div class="row align-items-end">
				<div class="col-lg-8">
					<div class="page-header-title">
						<div class="d-inline">
		                    <h4><g:message code="default.edit.label" default="Editar {0}" args="['Monto concepto deducible de Ganancia']"/></h4>
						</div>
					</div>
				</div>
				<div class="col-lg-4">
...
$(document).ready(function () {
	...
	document.querySelector('.alert-success-cancel').onclick = function(){
		swal({
			...
			text: "<g:message code='zifras.liquidacion.MontoConceptoDeducibleGanancia.delete.message' default='El monto se eliminará'/>",
			type: "warning",
		...
		function(isConfirm) {
			if (isConfirm) {
				window.location.href = $('#urlDelete').text() + '/' + ${montoConceptoDeducibleGananciaInstance?.montoConceptoDeducibleGananciaId};
			}
		});
	};
});
